...
//CARREGA AS OPÇÕES DE ESTADO CIVIL
    ...
    protected void CriarComponentes(){
        ...
        radioButtonMasculino = (RadioButton)
                this.findViewById(R.id.radioButtonMasculino);
        radioButtonFeminino = (RadioButton)
                this.findViewById(R.id.radioButtonFeminino);
        radioGroupSexo = (RadioGroup) this.findViewById(R.id.radioGroupSexo);
        editTextDataNascimento =
                (EditText)this.findViewById(R.id.editTextDataNascimento);
...
/*MENSAGEM DE SUCESSO!*/
    ...
    protected void CarregaEstadosCivis(){
        ...
        arrayAdapter = new ArrayAdapter<EstadoCivilModel>(this,
